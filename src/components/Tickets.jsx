...
const tickets = [
  ...
  },
  {
    ...
    features: [
      ...
      'Meet businesses, founders, recruiters, and hiring brands.',
      'Explore the Opportunity Playground and connect with Playgrounders.',
      'Discover career, business, and collaboration opportunities.',
      'Experience AI, business, and opportunity zones.',
      'Gain practical insights from industry experts.',
      'Access exhibitions and interactive experiences.',
    ],
    bestFor: 'Students, graduates, job seekers, freelancers, creators, young professionals, and anyone looking to unlock new opportunities.',
    cta: 'Get Talent Pass',
    ctaClass: '',
  ...
  },
  {
    ...
    badgeClass: '',
    features: [
      'Priority seating and premium event access.',
      'Full access to all Connexer sessions and Playgrounder experiences.',
      'Exclusive access to speakers, partners, and VIP networking opportunities.',
      'Access to VIP-only lounges, sessions, and experiences.',
      'Eligibility for Connexa Individual Awards & Recognition.',
      'Premium event experience with enhanced attendee benefits.',
      'Includes all Talent Pass benefits.',
    ],
    bestFor: 'Professionals, founders, executives, entrepreneurs, creators, and leaders who want greater access, visibility, recognition, and meaningful opportunities.',
  ...
  },
  {
    ...
    available: 500,  // ADD THIS
    features: [
      'Access to all Connexer sessions and panel discussions.',
      'Practical insights on business growth, sales, operations, and scaling.',
      'Connect with fellow founders and business owners.',
      'Access to Playgrounders and roaming business advisors for practical guidance.',
      'Priority seating with Business Owner recognition.',
      'Exclusive business-focused learning and growth experiences.',
      'Designed to help you identify opportunities, solve business challenges, and grow with confidence.'
    ],
    bestFor: 'Founders, entrepreneurs, SMEs, and business owners who want clarity, structure, practical solutions, and a roadmap for growth.',
  ...
  },
  {
    ...
    features: [
      ...
      'Attract real customers, partners, and collaborators.',
      'Access to Playgrounders and business advisors for practical business support.',
  ...
  },
  {
    ...
    features: [
      ...
      'A dedicated marketplace to showcase and sell your products or services.',
      'Direct access to attendees ready to discover, engage, and buy.',
      'Generate sales, capture leads, and increase brand visibility.',
      'Access to Playgrounders and business advisors for practical business support.',
      'Eligibility for the Connexa Brand Recognition Award.',
      'High foot traffic and real opportunities to grow your customer base.',
      'Learn practical business strategies while actively selling.',
    ],
    bestFor: 'Businesses, brands, SMEs, and vendors ready to sell, validate their products, build visibility, and close deals on the spot.',
    cta: 'Get Vendor Pass',
    ctaClass: 'cta-orange',
    dotColor: 'var(--orange)',
  },
